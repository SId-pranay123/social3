...
// // import contractABI from '../config/abi.json'; // Adjust the path as needed

// // const contractAddress = '0x10d6dA4e930ec0ed0331103787E7ABdB715dC0cc';
...
// // function ChirpingApp() {
// //   const contract = useContract();
// //   const [chirpings, setChirpings] = useState([]);
// //   const [users, setUsers] = useState([]);
// //   const [currentUser, setCurrentUser] = useState(null);

// //   // Function to fetch all chirpings
// //   useEffect(() => {
// //     if (!contract) return;
// //     const fetchChirpings = async () => {
// //       const chirpingData = await contract.getAllChirpings();
// //       setChirpings(chirpingData);
// //     };
// //     fetchChirpings();
// //   }, [contract]);
...
// //       const userData = await contract.showUsers();
// //       setUsers(userData);
// //     };
// //     fetchUsers();
// //   }, [contract]);
...
// //   // Add a chirping
// //   const handleAddChirping = async (numOfCharacters, chirpingText, chirpingImage) => {
// //     try {
// //       const transactionResponse = await contract.addChirping(numOfCharacters, chirpingText, chirpingImage);
// //       await transactionResponse.wait();
// //       console.log('Chirping added!');
// //     } catch (error) {
// //       console.error('Failed to add chirping:', error);
// //     }
// //   };

// //   // Give wings to a chirping
// //   const handleGivingWings = async (chirpingId) => {
// //     try {
// //       const transactionResponse = await contract.givingWings(chirpingId);
// //       await transactionResponse.wait();
// //       console.log('Wings given!');
// //     } catch (error) {
// //       console.error('Failed to give wings:', error);
// //     }
// //   };

// //   // Give cage to a chirping
// //   const handleGivingCage = async (chirpingId) => {
// //     try {
// //       const transactionResponse = await contract.givingCage(chirpingId);
// //       await transactionResponse.wait();
// //       console.log('Cage given!');
// //     } catch (error) {
// //       console.error('Failed to give cage:', error);
// //     }
// //   };
...
// //     try {
// //       const transactionResponse = await contract.promoteLevel();
// //       await transactionResponse.wait();
// //       console.log('User level promoted!');
// //     } catch (error) {
// //       console.error('Failed to promote level:', error);
// //     }
// //   };

// //   // Function to add a user
// //   const handleAddUser = async (username, displayPicture) => {
// //     try {
// //       const transactionResponse = await contract.addUser(username, displayPicture);
// //       await transactionResponse.wait();
...
// //   // Example of adding a user (could be triggered by UI)
// //   // handleAddUser('0x123...', 'ipfs://newPicture');

// //   return (
// //     <div>
// //       <h1>Chirping Platform</h1>
// //       {chirpings.map((chirping, index) => (
// //         <div key={index}>
// //           <p>{chirping.chirpingText} - {chirping.creator}</p>
// //         </div>
// //       ))}
// //       <button onClick={() => handleAddChirping(120, 'Hello Chirping!', 'ipfs://example_image')}>Add Chirping</button>
// //       <button onClick={() => handlePromoteLevel()}>Promote Level</button>
// //       {/* Additional UI components and buttons for other functions */}
// //     </div>
// //   );
// // }

// // export default ChirpingApp;
